...
bay_mapping = {
    ...
    'Bay2': {'red_led': 4, 'yellow_or_green_led': 14, 'sensor_trigger': 27, 'sensor_echo': 24, 'state': 0, 'prev_state': 0, 'bay_type': 'general', 'is_bay_booked' : 0},
    'Bay3': {'red_led': 15, 'yellow_or_green_led': 18, 'sensor_trigger': 22, 'sensor_echo': 10, 'state': 0, 'prev_state': 0, 'bay_type': 'general', 'is_bay_booked' : 0}
            }
